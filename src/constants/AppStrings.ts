export const APP_STRINGS = {
  ...
  eventScreen: {
    ...
    abandoned: 'ABANDONED',
    oddRegistrationsAlert:
      'One participant will not play as there is an odd number of registrations.',
    note: 'Note',
    categoryAbandoned: 'Category Abandoned',
    categoryAbandonedDescription:
      'This category has been abandoned due to insufficient registrations. Fixtures cannot be created.',
    individualMatches: 'Individual Matches',
    teamOfPlayers: 'Team of 2 players',
